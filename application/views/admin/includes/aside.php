   ...
   <ul class="nav metis-menu" id="side-menu">
      ...
      <li class="quick-links">
         <div class="dropdown dropdown-quick-links">
            <a href="#" class="dropdown-toggle" id="dropdownQuickLinks" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="line-height: 256px;">
      ...
      <?php foreach($sidebar_menu as $key => $item){
         ...
         if((isset($item['collapse']) && $item['collapse']) && count($item['children']) === 0) {
          ...
          if(($item['slug'] == "sales" || $item['slug'] == "expenses" ||
              $item['slug'] == "leads" || $item['slug'] == "estimate_request" || $item['slug'] == "reports")) {
              continue;
          }
         ?>
