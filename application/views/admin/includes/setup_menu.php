...
<div id="setup-menu-wrapper" class="animated <?php if($this->session->has_userdata('setup-menu-open')
    ...
    <ul class="nav metis-menu" id="setup-menu">
        ...
        if(($item['slug'] == "leads" || $item['slug'] == "finance" ||
            $item['slug'] == "contracts" || $item['slug'] == "estimate_request" || $item['slug'] == "modules"
            || $item['slug'] == "email-templates" || $item['slug'] == "custom-fields"
            || $item['slug'] == "gdpr" || $item['slug'] == "roles")) {
            continue;
        }
       $totalSetupMenuItems++;
       ?>
